          ...
          <div className="mx-auto mt-32 max-w-7xl px-6 sm:mt-40 lg:px-8">
            ...
            <div className="mx-auto mt-16 flex max-w-2xl flex-col gap-8 lg:mx-0 lg:mt-20 lg:max-w-none lg:flex-row lg:items-end">
              <div className="flex flex-col-reverse justify-between gap-x-16 gap-y-8 rounded-2xl bg-gray-50 dark:bg-gray-800 p-8 sm:w-3/4 sm:max-w-md sm:flex-row-reverse sm:items-end lg:w-72 lg:max-w-none lg:flex-none lg:flex-col lg:items-start">
                <p className="flex-none text-3xl font-bold tracking-tight text-gray-900 dark:text-gray-100">
                  250k
                </p>
                  ...
                  {jobOpenings.map((opening) => (
                    <li key={opening.id} className="py-8">
                      <dl className="relative flex flex-wrap gap-x-3">
                        ...
                        <dd className="mt-2 w-full flex-none text-base leading-7 text-gray-600 dark:text-gray-400">
                          {opening.description}
                        </dd>
                        <dt className="sr-only">Salary</dt>
                        <dd className="mt-4 text-base font-semibold leading-7 text-gray-900 dark:text-gray-100">
                          {opening.salary}
                        </dd>
                        ...
                        <dd className="mt-4 flex items-center gap-x-3 text-base leading-7 text-gray-500 dark:text-gray-400">
                          <svg
                            viewBox="0 0 2 2"
                            aria-hidden="true"
                            className="h-0.5 w-0.5 flex-none fill-gray-300 dark:fill-gray-600"
                          >
